...
speed, ETA, загруженный и общий размер для каждой задачи. Версии приложения и движков,
а также настройки concurrency, скорости, темы, языка и папки остаются в верхней зоне
без технических плашек.
