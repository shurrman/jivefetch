...
- Полное руководство по установке для macOS, Windows, Ubuntu/Debian, Fedora,
  ...
  установку и проверку `yt-dlp` и FFmpeg, сверку checksum JiveFetch, первый запуск и
  обновление движков.
...
- Документация: с 48 до 51 отслеживаемого Markdown-файла и с 16 до 17 проверяемых
